...
{{ simple.func_with_varargs(1) }}
{{ simple.func_with_varargs(1, 2) }}
{{ simple.func_with_varargs(a='a') }}
{{ simple.func_with_varargs(a='a', b='b') }}
{{ simple.func_with_varargs(1, 2, 3, a='a', b='b', c='c') }}
